...
# SAPMATH (SMART AI BASED MONEY PLANNING AND ANALYTICS TOOL) Finance Platform
...
### 💰 Account Management(MOCK GENERATOR)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/kundagolsharan-svg/SAMPAT_WEB/ai-finance-platform.git
...
**Made with "SAMPATH TEAM" using Next.js and AI**
